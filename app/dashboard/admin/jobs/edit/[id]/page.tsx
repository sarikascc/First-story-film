  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] lg:ml-[var(--sidebar-offset)] p-4 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-black text-slate-900 mb-1 font-heading tracking-tight uppercase leading-none">
            Edit Production Job
          </h1>
        </div>
            ...
            <section className="bg-white rounded-[1.5rem] border border-slate-100 shadow-xl overflow-hidden p-6 lg:p-8">
              <div className="flex items-center justify-between mb-6 border-b border-slate-50 pb-4">
                ...
                <div className="flex items-center px-4 h-8 bg-indigo-50 rounded-full">
                  <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mr-3">
                    Est. Commission
                  </span>
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-end">
                  ...
                  <div>
                    <label className="label text-[10px] uppercase font-black tracking-widest text-black mb-2 block ml-1">
                ...
                <div>
                  <label className="label text-[10px] uppercase font-black tracking-widest text-black mb-2 block">
